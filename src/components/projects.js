...
export default function Projects() {
    return(
        <div className = 'text'>
            ...
            <p> 1<sup>ST</sup> PLACE HEALTH & SUSTAINABILITY. RED BULL: BEST SPORTS HACK @ <a href = 'https://hacknyu.org/' style= {{textDecoration: 'none'}}>HACKNYU 2020</a></p>
            ...
            <br/>
            <h3> CHAT APP</h3>
            <h4>FEBRUARY 24 - MARCH 6, 2020</h4>
            <hr/>
